...
if (!empty($data->image_id)) {
    try {
        ...
        if ($stmt->execute()) {
            ...
            echo json_encode(["success" => false, "message" => "Unable to delete gallery item."]);
        }
    ...
    echo json_encode(["success" => false, "message" => "Unable to delete gallery item. ID is missing."]);
}
